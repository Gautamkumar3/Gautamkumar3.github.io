                ...
                <Flex justify={"space-between"} align={"center"} height="80px">
                    <Box>
                        <Text color="#1bc6ed" fontWeight={"bold"} fontSize="40px" ml={"15px"}>
                            G<span style={{ color: "#F5C32C" }}>K</span>
                        </Text>
                    </Box>
                    <Flex align="center">
                        ...
                        <Text>
                            <a style={{ fontSize: "22px" }} className='link' target={"blank"} href="https://drive.google.com/file/d/1oDEyN7wJAakasKxkFx8a1aWmcTTha4Hn/view?usp=share_link">
                                RESUME
                            </a>
                        </Text>
