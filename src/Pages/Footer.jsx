            ...
            <Flex w="80%" margin="auto" justifyContent="space-around" p="10px" flexWrap="wrap">
                <Flex alignItems={"center"} gap="10px" color={color} mt={4} >
                    ...
                    <Link href="tel:6201138922">
                        <Text textDecoration={"underline"}>+91 6201138922</Text>
                    </Link>
                </Flex>
                <Flex alignItems={"center"} gap="10px" color={color} mt={4} >
                    <IconButton size='sm' colorScheme='gray' _focus={{ outline: "none" }} icon={<EmailIcon fontSize="25px" color='blue' />} />

                    <Link href='mailto:g2gautamsingh@gmail.com'>
                        <Text textDecoration={"underline"}>g2gautamsingh@gmail.com</Text>
                    </Link>
                </Flex>
                ...
                <Flex alignItems={"center"} gap="10px" color={color} mt={4} >
                    ...
                    <Link href='https://github.com/Gautamkumar3' isExternal >
                ...
                <Flex alignItems={"center"} gap="10px" color={color} mt={4} >
                    ...
                    <Link href="https://www.linkedin.com/in/gautam-kumar-b542621a7/" isExternal >
