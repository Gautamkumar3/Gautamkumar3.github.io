                ...
                <Center bg={'gray.200'} h="100vh">
                    <Box w="90vw" m="auto" mt={10} >
                        <SimpleGrid w="90%" m="auto">
                            ...
                            <Box ml={10} mt={10}>
                                <Text fontSize="3xl" fontWeight="bold">Hello, my name is</Text>
                                <Heading my={3} size="2xl">Gautam Kumar</Heading>
                                <Text fontSize="2xl" fontWeight="bold">I'm a <span style={{ color: "#F5C32c" }}>Full Stack Web Developer</span> </Text>
                    ...
                    <Box w="90%" m="auto" p={5} h="70vh">
                        <Flex justify="space-between" w="100%" margin="auto" gap="10%" p={10} >
                            <Flex ml={10} w="50%" flexDir="column" justify="center">
                                ...
                                <Heading my={3} size={['xl', '2xl', '3xl', '4xl']}>Gautam Kumar</Heading>
                                <Text fontSize={['xl', '2xl', '3xl', '4xl']} fontWeight="bold">I'm a <span style={{ color: "#F5C32c" }}>Full Stack Web Developer</span> </Text>
                                <Button mt={5} fontWeight="bold" fontSize="20px" width="fit-content" color="white" bg="#F5C32c" _hover={{ variant: 'outline', color: "#F5C32c", bg: "white", border: "2px solid #F5c32c" }}>Resume</Button>
                            </Flex >
